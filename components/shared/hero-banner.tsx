    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                ...
                <div className="mt-4 sm:mt-5 inline-flex items-center gap-2 bg-brand-gold text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-full shadow-lg shadow-amber-500/25">
                    <span>📅</span>
                    Tahun Anggaran 2024
                </div>
            </div>
